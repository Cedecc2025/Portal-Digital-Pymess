...
const elements = {
  ...
  costFormContainer: null,
  transactionFormContainer: null,
  productosFields: {
    nombre: null,
    tipo: null,
    moneda: null,
...
// Ajusta el tamaño de todos los gráficos activos para que aprovechen el espacio disponible.
function resizeCharts() {
  Object.values(elements.charts).forEach((chartInstance) => {
...
// Programa un reajuste visual de los gráficos en el siguiente cuadro de animación.
...
function handleTabChange(event) {
  ...
  if (targetTab === "flujo" || targetTab === "analisis") {
    requestChartResize();
  }
}
...
function editarProducto(productId) {
  ...
  if (elements.productosFields.nombre) {
    ...
    elements.productosFields.nombre.focus();
  }
  if (elements.productosFields.tipo) {
  ...
  scrollElementIntoView(elements.productFormContainer ?? elements.prodFormTitle);
}
...
function editarCostoFijo(costId) {
  ...
  if (elements.costosFields.concepto) {
    ...
    elements.costosFields.concepto.focus();
  }
  if (elements.costosFields.moneda) {
  ...
  scrollElementIntoView(elements.costFormContainer ?? elements.costoFormTitle);
}
...
function editarTransaccion(transactionId) {
  ...
  if (elements.transaccionesFields.concepto) {
    ...
    elements.transaccionesFields.concepto.focus();
  }
  if (elements.transaccionesFields.moneda) {
  ...
  scrollElementIntoView(elements.transactionFormContainer ?? elements.transFormTitle);
}
...
function cacheElements() {
  ...
  elements.productFormContainer = document.querySelector("#tab-productos .panel");
  elements.costFormContainer = document.querySelector("#tab-costos .panel");
  elements.transactionFormContainer = document.querySelector("#tab-flujo .panel");
